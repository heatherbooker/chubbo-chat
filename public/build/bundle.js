...
/***/ function(module, exports, __webpack_require__) {
	...
	router.map({
	  ...
	  '/dashboard': {
	    ...
	    subRoutes: {
	      '/survey': {
	        component: _surveyForm2.default
	      },
	      '/responses': {
	        component: _responses2.default
	      }
	    }
	  },
	  '/surveys': {
	    component: _conversation2.default,
...
/***/ function(module, exports, __webpack_require__) {
	...
	//services
	//libraries
	module.exports = _vue2.default.extend({
	  ready: function ready() {
	    //animate background canvas
	    (0, _floatingDots2.default)();
	  },
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = function () {
	  ...
	  if (canvas) {
	    var context, colors, minSize, maxSize, numCircles, minSpeed, maxSpeed, expandState;
	    var xVal;
	    var navbarHeight;
	    var delay;
	    ...
	    (function () {
	      ...
	      var buildArray = function buildArray() {
	        circles = [];
	        'use strict';
	      ...
	      var animate = function animate(shouldPause) {
	        var pause = false;
	        if (shouldPause) {
	          pause = true;
	        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = _vue2.default.extend({
	  ...
	  components: {
	    'title-input': _titleInput2.default,
	    'question-input': _questionInput2.default
	  },
	  ready: function ready() {
	    $('.cc-titleInput').focus();
	    var me = this;
	    ...
	    me.unsubscribeAuthListener = firebase.auth().onAuthStateChanged(function (user) {
	      ...
	      if (user) {
	        ...
	        _surveyApi2.default.getSurveys().then(function (response) {
	  ...
	  methods: {
	    populateSurveyFields: function populateSurveyFields(data, me) {
	    ...
	    handlePublishButton: function handlePublishButton() {
	    ...
	    tidyQuestions: function tidyQuestions() {
	    ...
	    isValidatedData: function isValidatedData() {
	      if (!this.title) {
	        $('.cc-titleInput').focus();
	    ...
	    publishToDatabaseAndStore: function publishToDatabaseAndStore(finalQuestions, me) {
	      var published = false;
	    ...
	    publishSurveyToDatabase: function publishSurveyToDatabase(finalQuestions) {
	      var me = this;
	      return _surveyApi2.default.publishSurvey('{\n        "surveyTitle": "' + this.title + '",\n        "questions": [' + finalQuestions + '],\n        "timestamp": "' + Date.now() + '"\n      }').then(function (response) {
	  ...
	  vuex: {
	    ...
	    actions: {
	      publishSurveyToStore: function publishSurveyToStore(store, finalQuestions) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = _vue2.default.extend({
	  ...
	  computed: {
	    ...
	    isSoleAndEmptyInput: function isSoleAndEmptyInput() {
	  ...
	  methods: {
	    dispatchEnterEvent: function dispatchEnterEvent() {
	  ...
	  vuex: {
	    actions: {
	      updateQuestionInStore: function updateQuestionInStore() {
	        _store2.default.dispatch('editQuestion', this.index, this.question);
	      }
	    }
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = _vue2.default.extend({
	  ...
	  computed: {
	    hasErrorClass: function hasErrorClass() {
	      if (this.errorStatus) {
	  ...
	  methods: {
	    moveFocusToQuestion: function moveFocusToQuestion() {
	  ...
	  vuex: {
	    actions: {
	      updateTitleInStore: function updateTitleInStore() {
	        _store2.default.dispatch('editTitle', this.title);
	      }
	    }
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./surveyForm.css", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./surveyForm.css");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".cc-surveyFormPage {\n  -webkit-box-flex: 3;\n  -webkit-flex: 3;\n  -ms-flex: 3;\n  flex: 3;\n  display: -webkit-box;\n  display: -ms-flexbox;\n  display: -webkit-flex;\n  display: flex;\n  justify-content: center;\n  flex-wrap: wrap;\n}\n\n.cc-surveyFormInputs {\n  width: 60%;\n  counter-reset: up-by-one;\n}\n\n.cc-submitBtnContainer {\n  width: 20%;\n  -webkit-align-items: flex-end;\n  align-items: flex-end;\n  display: -webkit-box;\n  display: -ms-flexbox;\n  display: -webkit-flex;\n  display: flex;\n}\n\n.cc-titleInput {\n  background-color: #fff;\n  border: none;\n  border-bottom: 1px solid #A4A4A4;\n  border-radius: 0px;\n  margin: 20px 10px;\n  font-size: 2.5rem;\n  -webkit-box-flex: 1;\n  -webkit-flex: 1;\n  -ms-flex: 1;\n  flex: 1;\n  min-width: 0px !important;\n}\n\n.cc-questionInputRow, .cc-titleInputRow {\n  margin: 5px;\n  display: -webkit-box;\n  display: -ms-flexbox;\n  display: -webkit-flex;\n  display: flex;\n}\n\ninput.cc-questionInput:focus, input.cc-titleInput:focus {\n  outline: none;\n  border-color: #3c5a71;\n}\n\n.cc-titleInput-error, input.cc-titleInput-error:focus {\n  border: 1px solid rgb(234, 32, 28);\n  border-radius: 20px;\n  padding-left: 8px;\n}\n\n.cc-questionInputRow {\n  counter-increment: up-by-one;\n}\n\n.cc-questionInput {\n  background-color: #fff;\n  box-shadow: none;\n  border: 1px solid #A4A4A4;\n  border-radius: 20px;\n  margin: 20px 10px;\n  padding: 3px 7px;\n  font-size: 2.2rem;\n  -webkit-box-flex: 1;\n  -webkit-flex: 1;\n  -ms-flex: 1;\n  flex: 1;\n  min-width: 0px !important;\n}\n\n.cc-questionInputRow:before {\n  content: counter(up-by-one) \".\";\n  font-size: 2.5rem;\n  margin: auto 5px;\n  color: #8E8E8E;\n  font-weight: bold;\n}\n\n.cc-submitSurveyFormBtn, .cc-addQuestionInputBtn {\n  border-radius: 20px;\n  color: #fff;\n  background-color: #9DE934;\n  text-align: center;\n  font-size: 2rem;\n  font-weight: bold;\n  padding: 6px 15px;\n  margin: 5px auto 22px auto;\n}\n\n.cc-addQuestionInputBtn {\n  display: none;\n  margin: 35px 7% 5px 16%;\n}\n\n.cc-submitSurveyFormBtn:hover, .cc-addQuestionInputBtn {\n  cursor: pointer;\n}\n\n.cc-deleteQuestionIcon, .cc-deleteQuestionIcon-hide {\n  visibility: hidden;\n  font-size: 2.5rem;\n  margin: auto 0px;\n  padding-bottom: 5px;\n  color: #8E8E8E;\n}\n\n.cc-questionInputRow:hover .cc-deleteQuestionIcon {\n  visibility: visible;\n}\n\n.cc-deleteQuestionIcon:hover {\n  cursor: pointer;\n}\n\n@media (max-width: 992px) {\n  .cc-surveyFormPage {\n    display: block;\n  }\n  .cc-surveyFormInputs {\n    width: 90%;\n    margin: auto;\n  }\n  .cc-submitBtnContainer {\n    width: 100%;\n  }\n  .cc-submitSurveyFormBtn {\n    margin: 5px auto;\n    padding: 6px 35px;\n    border-radius: 26px;\n  }\n  .cc-deleteQuestionIcon {\n    visibility: visible;\n  }\n  .cc-addQuestionInputBtn {\n    display: inline-block;\n  }\n}\n\n.swal2-input:not([type=\"file\"]) {\n  font-size: 14px;\n  text-overflow: ellipsis;\n  width: 85%;\n  min-width: 1px;\n  margin-left: 0;\n}\n\n.swal2-input:focus:not([type=\"file\"]) {\n  border: 1px solid #d7d7d7;\n  box-shadow: none;\n}\n\nbutton.swal2-confirm.styled {\n  border-color: rgb(121, 205, 205);\n  background-color: rgb(121, 205, 205) !important;\n}\n\n.swal2-modal .cc-copyBtn {\n  color: rgb(121, 205, 205);\n  position: relative;\n  left: 43%;\n  top: 50px;\n}\n\n.swal2-modal .cc-copyBtn:hover {\n  cursor: pointer;\n}\n\n@media (max-width: 540px) {\n  .swal2-input:not([type=\"file\"]) {\n    margin: 20px 0px;\n    width: 75%;\n  }\n  .swal2-modal {\n    width: 250px !important;\n    margin-left: auto !important;\n    margin-right: auto !important;\n  }\n}\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = _vue2.default.extend({
	  ...
	  methods: {
	    toggleResponses: function toggleResponses() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./responses.css", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./responses.css");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".cc-responsesPage {\n  -webkit-box-flex: 3;\n  -webkit-flex: 3;\n  -ms-flex: 3;\n  flex: 3;\n  display: -webkit-box;\n  display: -ms-flexbox;\n  display: -webkit-flex;\n  display: flex;\n  justify-content: flex-start;\n  align-items: center;\n  flex-direction: column;\n}\n\n.cc-responsesPage-content {\n  margin: 20px;\n}\n\n.cc-responsesPage-question {\n  font-size: 18px;\n}\n\n.cc-responsesPage-question:hover {\n  cursor: pointer;\n}\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = _vue2.default.extend({
	  ...
	  vuex: {
	    getters: {
	      isLeftPanelVisible: function isLeftPanelVisible(state) {
	        return state.isLeftPanelVisible;
	      }
	    },
	    actions: {
	      hideMenuMobile: function hideMenuMobile() {
	        _store2.default.dispatch('toggleLeftPanel', false);
	      },
	      createNewSurvey: function createNewSurvey() {
	        _store2.default.dispatch('startDraft');
	      }
	    }
	  }
	});
	...
	exports.default = _vue2.default.extend({
	  ...
	  vuex: {
	    ...
	    getters: {
	      ...
	      emailField: function emailField(state) {
	        return state.userInfo.email;
	      },
	      userPic: function userPic(state) {
	        return state.userInfo.imgSrc;
	      }
	    }
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./leftPanel.css", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./leftPanel.css");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".cc-leftPanel-mobile-hide, .cc-leftPanel-mobile-show {\n  border-right: 1px solid #F0F0F0;\n  width: 25%;\n  padding-top: 30px;\n  -webkit-flex: 1;\n  flex: 1;\n  min-height: 100%;\n}\n\n.cc-userIcon-leftPanel {\n  width: 120px;\n  height: 120px;\n  border-radius: 50%;\n  display: block;\n  margin: 0px auto 30px auto;\n}\n\n.cc-userEmail-leftPanel {\n  color: #545454;\n  text-align: center;\n  margin: 10px;\n}\n\n.cc-leftPanel-seperatingLine {\n  width: 50%;\n  margin-top: 60px;\n  margin-bottom: 30px;\n}\n\na.cc-leftPanel-surveyBtn, a.cc-leftPanel-responsesBtn, a.cc-leftPanel-surveyBtn-selected, a.cc-leftPanel-responsesBtn-selected {\n  display: block;\n  text-align: center;\n  font-size: 1.8rem;\n  width: 90%;\n  margin: 19px auto;\n  padding: 9px 0px;\n  border: 1px solid transparent;\n}\n\na:link.cc-leftPanel-surveyBtn-selected, a:link.cc-leftPanel-responsesBtn-selected {\n  border: 1px solid #F0F0F0;\n}\n\n.cc-logout-leftPanel {\n  text-align: center;\n  display: none;\n}\n\n.cc-logout-leftPanel:hover {\n  cursor: pointer;\n}\n\n@media (max-width: 992px) {\n  .cc-logout-leftPanel {\n    display: block;\n  }\n  .cc-leftPanel-mobile-hide {\n    transition: left .3s ease;\n    position: absolute;\n    left: calc(-100% - 15px);\n    z-index: 2;\n    background-color: #fff;\n  }\n  .cc-leftPanel-mobile-show {\n    transition: left .3s ease;\n    position: absolute;\n    width: 83%;\n    left: 0px;\n    /*on top of greyed out survey form (z-index=1) */\n    z-index: 2;\n    background-color: #fff;\n  }\n  .cc-leftPanel-seperatingLine {\n    margin-top: 30px;\n    margin-bottom: 25px;\n  }\n  .cc-leftPanel-surveyBtn, .cc-leftPanel-responsesBtn, .cc-leftPanel-surveyBtn-selected, .cc-leftPanel-responsesBtn-selected {\n    width: 80%;\n  }\n}\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".cc-dashboardPage {\n  display: -webkit-box;\n  display: -ms-flexbox;\n  display: -webkit-flex;\n  display: flex;\n  position: absolute;\n  width: 100%;\n  /*navbar is 90px*/\n  min-height: calc(100% - 90px);\n}\n\n@media (max-width: 992px) {\n  .cc-dashboardPage {\n    min-height: calc(100% - 77px);\n  }\n  .cc-greyedSurveyForm {\n    display: -webkit-box;\n    display: -ms-flexbox;\n    display: -webkit-flex;\n    display: flex;\n    opacity: 0.5;\n    background-color: #737373;\n    position: absolute;\n    left: 0;\n    width: 100%;\n    min-height: 100%;\n    /*on top of survey form*/\n    z-index: 1;\n  }\n}\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = _vue2.default.extend({
	  ...
	  components: {
	    'message-bubble': _messageBubble2.default
	  },
	  data: function data() {
	    return {
	      chatInput: '',
	  ...
	  computed: {
	    sendBtnClass: function sendBtnClass() {
	      if (this.chatInput === '') {
	  ...
	  methods: {
	    setUpSurvey: function setUpSurvey() {
	      var me = this;
	      return _surveyApi2.default.getSpecificSurvey(me.surveyInfo.userId, me.surveyInfo.surveyId).then(function (response) {
	        return response.json();
	      }).then(function (data) {
	    ...
	    handleSubmitMsg: function handleSubmitMsg() {
	      if (this.chatInput !== '') {
	        this.messages.push({
	          text: this.chatInput,
	          sender: 'user'
	    ...
	    sendSurveyQuestion: function sendSurveyQuestion(me) {
	    ...
	    sendToDatabase: function sendToDatabase() {
	      _surveyApi2.default.sendSurveyResponses(this.surveyInfo.userId, this.surveyInfo.surveyId, '[' + this.surveyResponses + ']');
	    }
	  }
	});
	//styles
	...
	exports.default = _vue2.default.extend({
	  ...
	  computed: {
	    ...
	    finalMessage: function finalMessage() {
	      ...
	      var messageWithLinksEncoded = _anchorme2.default.js(htmlEscapedMessage, { html: false });
	  ...
	  methods: {
	    escapeHtml: function escapeHtml(message) {
	      return message.replace(/&/g, '&amp;').replace(/"/g, '&quot;').replace(/'/g, '&#39;').replace(/</g, '&lt;').replace(/>/g, '&gt;');
	    },
	    removeSpaces: function removeSpaces(message) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function (window) {
	  ...
	  anchorme.checks.ip = function (str) {
	    if (anchorme.occurrences(str, ".") > 2) {
	      ...
	      if (proOC === false || proOC.charAt(0) === "/" || proOC.charAt(0) === ":") {
	        if (!isNaN(oc1) && !isNaN(oc2) && !isNaN(oc3) && !isNaN(oc4) && oc1 - 1 <= 254 && oc2 - 1 <= 254 && oc3 - 1 <= 254 && oc4 - 1 <= 254 && oc1.length > 0 && oc2.length > 0 && oc3.length > 0 && oc4.length > 0) {
	          return true;
	        }
	      }return false;
	    }return false;
	  ...
	  anchorme.checks.email = function (str, howManyTLDsToCheck) {
	    ...
	    if (anchorme.occurrences(str, "@") == 1) {
	      ...
	      if (EmailAllowed) {
	        ...
	        if (validTLD === true) return true;else return false;
	      } else return false;
	    }return false;
	  };
	  ...
	  anchorme.order = function (input, options) {
	    ...
	    **/
	    var fixSpecialCharacters = function fixSpecialCharacters(arr, charStart, charEnd) {
	      for (var x = 0; x < arr.length; x++) {
	        if (arr[x].indexOf(".") > -1 && arr[x] !== "" && !(arr[x - 1] === charStart && arr[x + 1] === charEnd) && (arr[x + 1] === charStart || arr[x + 1] === charEnd)) {
	          arr[x] = arr[x] + arr[x + 1];
	          ...
	          arr.splice(x + 1, 4);
	          fixSpecialCharacters(arr, charStart, charEnd);
	        }
	      }
	    };

	    fixSpecialCharacters(splitedArray, '(', ')');
	    fixSpecialCharacters(splitedArray, '[', ']');
	    fixSpecialCharacters(splitedArray, "&#39;", "&#39;");
	      ...
	      **/
	      ...
	      if (fragment.indexOf(".") > -1) {
	        ...
	        if (allAllowed) {
	          ...
	          if (options.urls && (fragment.startsWith("http://") || fragment.startsWith("HTTP://"))) isurl = true;else if (options.urls && (fragment.startsWith("https://") || fragment.startsWith("HTTPS://"))) isurl = true;else if (options.urls && (fragment.startsWith("ftp://") || fragment.startsWith("FTP://"))) isurl = true;else if (options.urls && (fragment.startsWith("file:///") || fragment.startsWith("FILE:///"))) isurl = true;else if (options.emails && (fragment.startsWith("mailto:") || fragment.startsWith("MAILTO:"))) isurl = true;
	  ...
	  anchorme.js = function (str, options) {
	     ...
	     * such as: line breaks, braces, angle brackets and quotes
	     * 
	     **/
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "html, body{\n\theight: 100%;\n}\n\na {\n\ttext-decoration: underline;\n}\n\n#chubbo-chat {\n\theight: 100%;\n}\n\n.cc-chatPage {\n\tdisplay: -webkit-flex;\n\tdisplay: flex;\n\talign-items: center;\n\tflex-direction: column;\n\tjustify-content: flex-end;\n\theight: calc(100% - 90px);\n}\n\n.cc-chat-content {\n\tdisplay: flex;\n\tflex-direction: column;\n\tjustify-content: flex-end;\n\twidth: 50%;\n\theight: 100%;\n\tborder-left: 1px solid #bdbdbd;\n\tborder-right: 1px solid #bdbdbd;\n}\n\n.cc-chat-messages {\n\toverflow-y: auto;\n\t/*60px text input box*/\n\tmax-height: calc(100% - 60px);\n}\n\n.cc-chatRow-bot, .cc-chatRow-reply {\n\tdisplay: -webkit-flex;\n\tdisplay: flex;\n\talign-items: flex-end;\n\tflex-direction: row-reverse;\n\tmax-width: 100%;\n\tmargin: 5px;\n}\n\n.cc-chatRow-bot {\n\tflex-direction: row;\n}\n\n.cc-chatBubble-bot, .cc-chatBubble-reply {\n\tpadding: 7px 15px;\n\tmargin: 10px;\n\tborder-radius: 20px;\n\tposition: relative;\n\tmax-width: 70%;\n\tfont-size: 16px;\n\toverflow-wrap: break-word;\n\tword-wrap: break-word;\n\t-ms-word-break: break-all;\n\tword-break: break-word;\n\t-ms-hyphens: auto;\n\t-moz-hyphens: auto;\n\t-webkit-hyphens: auto;\n\thyphens: auto;\n}\n\n.cc-chatBubble-bot {\n\tbackground-color: #3c5a71;\n\tcolor: #fff;\n}\n\n.cc-chatBubble-reply {\n\tborder: 1px solid #bdbdbd;\n}\n\n.cc-chat-createSurveyLink {\n\tfont-weight: bold;\n}\n\n.cc-chat-createSurveyLink:hover {\n\tcolor: white;\n}\n\n/*input and send btn at bottom*/\n\n.cc-chat-inputBlock {\n\tborder-top: 1px solid #bdbdbd;\n\tdisplay: flex;\n\tdisplay: -webkit-flex;\n\theight: 60px;\n}\n\ninput.cc-chat-input {\n\tflex: 9;\n\tborder: none;\n\tpadding: 10px;\n\tfont-size: 16px;\n\tmin-width: 0px !important;\n}\n\ninput.cc-chat-input:focus {\n\tbox-shadow: none;\n\toutline: none;\n}\n\n.cc-chat-sendBtn, .cc-chat-sendBtn-disabled {\n\tflex: 1;\n\tfont-size: 24px;\n\twidth: 10%;\n\tmargin: auto;\n\tpadding: 10px;\n}\n\n.cc-chat-sendBtn-disabled {\n\tcolor: #bdbdbd;\n}\n\n.cc-chat-sendBtn:hover {\n\tcursor: pointer;\n}\n\n\n@media (max-width: 992px) {\n\t.cc-chatPage {\n\t\theight: calc(100% - 77px);\n\t}\n}\n\n@media (max-width: 768px) {\n\t.cc-chat-content {\n\t\tborder: none;\n\t\twidth: 100%;\n\t}\n\t.cc-chat-sendBtn, .cc-chat-sendBtn-disabled {\n\t\tfont-size: 18px;\n\t}\n}\n", ""]);
...
/***/ function(module, exports) {
	...
	var Login = function Login(onAuthStateChangeCallback) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = _vue2.default.extend({
	  ...
	  computed: {
	    ...
	    onSimpleNav: function onSimpleNav() {
	  ...
	  vuex: {
	    getters: {
	      isMenuVisible: function isMenuVisible(state) {
	        return state.isLeftPanelVisible;
	      },
	      user: function user(state) {
	        return state.userInfo;
	    ...
	    actions: {
	      showMenu: function showMenu() {
	        _store2.default.dispatch('toggleLeftPanel', true);
	      },
	      hideMenu: function hideMenu() {
	        _store2.default.dispatch('toggleLeftPanel', false);
	      }
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "body {\n  font-family: 'Quicksand', sans-serif;\n  color: #3c5a71;\n}\n\na {\n  color: inherit;\n}\na:hover {\n  text-decoration: none;\n  color: inherit;\n}\na:focus {\n  color: inherit;\n}\na:link, a:visited {\n  text-decoration: none;\n  outline: none;\n  border-style: none;\n}\n\n.cc-navbar {\n  border-bottom: 2px solid #F0F0F0;\n}\n\n.cc-logo {\n  font-family: 'Pacifico', cursive;\n  display: inline-block;\n  margin: 20px 5px;\n  font-size: 3.3rem;\n}\n\n.cc-logo:hover {\n  cursor: pointer;\n}\n\n.cc-menuIcon-mobile {\n  display: none;\n  height: 30px;\n  width: auto;\n  margin: 20px 3px;\n  padding: 2px;\n  float: right;\n}\n\n.cc-menuIcon-clicked {\n  box-shadow: 1px 1px 1px #89a5ba inset;\n  border: 1px solid #b5c8d7;\n  border-radius: 2px;\n}\n\n.cc-menuIcon-mobile:hover {\n  cursor: pointer;\n}\n\n.cc-loginBtn, .cc-logoutBtn, .cc-dashboardShortcut {\n  float: right;\n  padding: 10px;\n  font-size: 2rem;\n}\n\n.cc-loginBtn:hover, .cc-logoutBtn:hover, .cc-dashboardShortcut:hover {\n  cursor: pointer;\n  font-weight: bold;\n}\n\n@media (max-width: 992px) {\n  .cc-logo {\n    font-size: 2.5rem;\n  }\n .cc-loginBtn, .cc-logoutBtn, .cc-dashboardShortcut {\n    font-size: 1.8rem;\n    margin-top: 12px;\n    margin-bottom: 12px;\n  }\n  .cc-menuIcon-mobile {\n    display: block;\n  }\n  .cc-logoutBtn {\n    display: none;\n  }\n}\n\n", ""]);
