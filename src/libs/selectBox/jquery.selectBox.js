/*
 * $ selectBox - A cosmetic, styleable replacement for SELECT elements
 *
 * Licensed under the MIT license: http://opensource.org/licenses/MIT
 *
 * v1.2.0
 *
 * https://github.com/marcj/$-selectBox
 */
;(function () {
     ...
     * SelectBox class.
     *
     * @param {HTMLElement|$} select If it's a $ object, we use the first element.
